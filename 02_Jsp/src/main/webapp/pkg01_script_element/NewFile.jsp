...
<%-- JSP 주석 : "소스 보기"에서 안보인다. Java 코드를 주석처리할 수 있다. --%>
...
<body>
  ...
  <div><%=getTen()%></div>
    ...
    <%--
      Java와 JavaScript
      1. Java 변수를 JavaScript 에서 사용할 수 있다. (JavaScript 에서 표현식을 사용)
      2. 반대는 안됨
     --%>
    ...
    <%-- 연습. 현재 날짜와 시간을 yyyy-MM-dd HH:mm:ss.SSS 형식의 문자열을 반환하는 getNow()메소드를 만들고 호출 --%>
