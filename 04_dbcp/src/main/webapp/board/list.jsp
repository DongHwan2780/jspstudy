...
<body>
  ...
  <div>
    <a href="${contextPath}/board/write.brd">새 게시글작성</a>
  </div>
  ...
  <div>
    <a href="${contextPath }/board/list.brd?=page1&sort=DESC&display=${display}">내림차순</a>
    <span>||</span>
    <a href="${contextPath }/board/list.brd?=page1&sort=ASC&display=${display}">오름차순</a>
  </div>
